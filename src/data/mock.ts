...
export const syllabus: SyllabusPaper[] = [
  {
    ...
    topics: [
      { id: "t1", name: "Ancient & Medieval History", progress: 78 },
      { id: "t2", name: "Modern India & Freedom Struggle", progress: 92 },
      { id: "t3", name: "Art & Culture", progress: 64 },
      { id: "t4", name: "World History", progress: 41 },
      { id: "t5", name: "Indian Society", progress: 70 },
      { id: "t6", name: "Physical & Human Geography", progress: 55 },
    ],
  },
  {
    id: "gs2", name: "GS Paper II — Polity, Governance, IR",
    topics: [
      { id: "t7", name: "Constitution & Polity", progress: 84 },
      { id: "t8", name: "Governance & Social Justice", progress: 60 },
      { id: "t9", name: "International Relations", progress: 48 },
      { id: "t10", name: "Welfare Schemes", progress: 72 },
    ],
  },
  {
    id: "gs3", name: "GS Paper III — Economy, Environment, S&T, Security",
    topics: [
      { id: "t11", name: "Indian Economy", progress: 68 },
      { id: "t12", name: "Environment & Ecology", progress: 74 },
      { id: "t13", name: "Science & Technology", progress: 52 },
      { id: "t14", name: "Internal Security", progress: 39 },
      { id: "t15", name: "Disaster Management", progress: 58 },
    ],
  },
  {
    id: "gs4", name: "GS Paper IV — Ethics, Integrity, Aptitude",
    topics: [
      { id: "t16", name: "Ethics — Theory & Thinkers", progress: 45 },
      { id: "t17", name: "Case Studies", progress: 33 },
      { id: "t18", name: "Public Service Values", progress: 58 },
    ],
  },
];
